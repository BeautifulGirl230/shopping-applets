...
<style>
	...
	@font-face {font-family: "iconfont";
	  src: url('https://github.com/BeautifulGirl230/resources/tree/master/fonts/font-size/iconfont.eot?t=1576844226174'); /* IE9 */
	  src: url('https://github.com/BeautifulGirl230/resources/tree/master/fonts/font-size/iconfont.eot?t=1576844226174#iefix') format('embedded-opentype'), /* IE6-IE8 */
	  ...
	  url('https://github.com/BeautifulGirl230/resources/tree/master/fonts/font-size/iconfont.woff?t=1576844226174') format('woff'),
	  url('https://github.com/BeautifulGirl230/resources/tree/master/fonts/font-size/iconfont.ttf?t=1576844226174') format('truetype'), /* chrome, firefox, opera, Safari, Android, iOS 4.2+ */
	  url('https://github.com/BeautifulGirl230/resources/tree/master/fonts/font-size/iconfont.svg?t=1576844226174#iconfont') format('svg'); /* iOS 4.1- */
	}
